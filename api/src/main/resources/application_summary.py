...
def spark_application(job_name):
    ...
    if yarn_data != None:
        ...
        elif yarn_data['state'] == 'SUBMITTED' or yarn_data['state'] == 'ACCEPTED':
...
def process_application_data(application):
    ...
    for component in application:
        ...
        elif temp_comp_status == 'STARTING' or temp_comp_status == 'SUBMITTED' or temp_comp_status == 'ACCEPTED':
        ...
        elif temp_comp_status == 'SUSPENDED_WITH_FAILURES' or temp_comp_status == 'FAILED':
            temp_status_priority = 6
        elif temp_comp_status == 'KILLED':
            temp_status_priority = 7
        elif temp_comp_status == 'KILLED_WITH_FAILURES':
            temp_status_priority = 8
        elif temp_comp_status == 'COMPLETED' or temp_comp_status == 'SUCCEEDED':
            temp_status_priority = 9
        elif temp_comp_status == 'COMPLETED_WITH_FAILURES':
